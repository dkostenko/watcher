...
RANLIB=ranlib
CC=gcc
CCC=i586-mingw32-gcc
CXX=i586-mingw32-gcc
FC=gfortran
AS=as
...
${OBJECTDIR}/LucasKanade.o: LucasKanade.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/LucasKanade.o LucasKanade.cpp

${OBJECTDIR}/Watcher.o: Watcher.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/Watcher.o Watcher.cpp
